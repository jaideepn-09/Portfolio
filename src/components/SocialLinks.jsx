...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: FaLinkedin,
    url: "https://www.linkedin.com/in/jaideep-n-b647ab228",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@jai_deepn02",
    icon: FaInstagram,
    url: "https://www.instagram.com/jai_deepn02",
    color: "#E4405F",
  ...
  },
  {
    ...
    url: "https://t.me/Jaideep_N",
    color: "#00BBFF",
    gradient: "from-[#00BBFF] to-[#00EBEF]"
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@jaideepn-09",
    icon: FaGithub,
    url: "https://github.com/jaideepn-09",
    color: "#ffffff",
  ...
  },
  {
    ...
    subText: "@jaiDeepn09",
    icon: FaTwitter, 
    url: "https://x.com/jaiDeepn09", 
    color: "#00AAff", 
    gradient: "from-[#1DA1F2] via-[#25F4EE] to-[#25CEFF]", 
  }
